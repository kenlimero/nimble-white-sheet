...
function vi(e, t) {
  Se(t, !0);
  let n = /* @__PURE__ */ Le(""), a = /* @__PURE__ */ F(() => t.actor.reactive.items.filter((E) => E.type === "spell").sort((E, M) => E.name.localeCompare(M.name))), s = /* @__PURE__ */ F(() => c(n) ? c(a).filter((E) => E.name.toLowerCase().includes(c(n).toLowerCase())) : c(a)), r = /* @__PURE__ */ F(() => {
    const E = {};
    for (const M of c(s)) {
